...
class AppLocalizations {
  ...
  static final Map<String, Map<String, String>> _localizedValues = {
    'en': {
      ...
      'privateProfileOnLabel': 'Private — hidden from other players',
      'privateProfileOffLabel': 'Normal — visible to other players',
      ...
      'privateProfileBlocked': 'This player\'s profile is private, so you can\'t view their number or attendance',
    ...
    'ar': {
      ...
      'privateProfileTitle': 'خصوصية البروفايل',
      'privateProfileOnLabel': 'خاص — مخفي عن باقي البلايرز',
      'privateProfileOffLabel': 'عادي — ظاهر لباقي البلايرز',
      ...
      'privateProfileBlocked': 'بروفايل اللاعب ده خاص، مش هتقدر تشوف رقمه أو حضوره',
